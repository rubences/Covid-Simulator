...
class Main {
  public static void main(String[] args) {
    ...
    while(player.alive == true){
      ...
      if(player.happy <= 0){
        if(player.money>100){
          System.out.println("You were too sad and need Therapy for $100!(y/n)");
          answer = s.nextLine();
        }
        else{
          System.out.println("You were too sad and can't afford Therapy. Game Over!");
          System.out.println("You survived for " + player.turn + " turns.");
          player.alive = false;
          break;
        }
      ...
      if(answer.equals("y")){
        ...
        System.out.println("You were too sad and didn't get Therapy. Game Over!");
        System.out.println("You survived for " + player.turn + " turns.");
        player.alive = false;
        break;
      }
